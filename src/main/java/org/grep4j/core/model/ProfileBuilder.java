...
/**
 * Builder class for {@link Profile} and {@link ServerDetails} Remote Profile
 * Example:
 * 
 * <pre>
 * new ProfileBuilder().name(&quot;Remote file&quot;).filePath(&quot;/path/to/file/filename.txt&quot;).onRemotehost(&quot;172.xx.xx.xx&quot;)
...
public class ProfileBuilder {
	...
	/**
	 * The hostname of the server where the target file is stored will be
	 * set to "localhost".
	 * 
	 * @return
	 */
	 ...
	 * 
	 * In case of a local server, the hostname has to be either "localhost"
	 * or "127.0.0.1"
	 * 
	 * @param host
	 */
	...
	/**
	 * Username required to connect to remote machine Password required to
