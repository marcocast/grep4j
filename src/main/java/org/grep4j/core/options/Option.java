...
public class Option {
    ...
    public static final String TAIL_OPTION = "tail.option";
	...
	return new Option(GREP_OPTION, "-A", String.valueOf(lines));
    }
	...
	return new Option(GREP_OPTION, "-B", String.valueOf(lines));
    }
	...
	return new Option(GREP_OPTION, "-C", String.valueOf(lines));
    }
	...
	return new Option(GREP_OPTION, "-o");
    }
	...
	return new Option(GREP_OPTION, "-i");
    }
	...
	return new Option(GREP_OPTION, "-v");
    }
	...
	return new Option(GREP_OPTION, "-c");
    }
	...
	return new Option(GREP_OPTION, "-H");
    }
	...
	return new Option(GREP_OPTION, "-m", String.valueOf(maxMatches));
    }
	...
	return new Option(GREP_OPTION, "-n");
    }
	...
	return new Option(GREP_OPTION, "-L");
    }
	...
	return new Option(SSH_CONNECTION_LIMIT_OPTION, "", String.valueOf(numberOfConnections));
    }
	...
	return new Option(TAIL_OPTION, " | tail -n", String.valueOf(numberOfLines));
    }
	...
	return new Option(TAIL_OPTION, " | tail -c", String.valueOf(numberOfBytes));
    }
	...
	return new Option(TAIL_OPTION, " | head -n", String.valueOf(numberOfLines));
    }
	...
	return new Option(TAIL_OPTION, " | head -c", String.valueOf(numberOfBytes));
    }
	...
	return new Option(GREP_OPTION, "--version");
    }
